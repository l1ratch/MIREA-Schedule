...
> [!NOTE]
> **Неофициальный проект**, не связан с РТУ МИРЭА. Приложение только отображает расписание и схемы корпусов из официальных источников; права на данные принадлежат их авторам.
